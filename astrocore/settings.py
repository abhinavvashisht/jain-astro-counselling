"""
Django settings for astrocore project.
...
ALLOWED_HOSTS = ['jain-astro-counselling.onrender.com', 'localhost']
...
WSGI_APPLICATION = 'astrocore.wsgi.application'
